...
-->
    ...
    <form method="POST" class="row g-3 needs-validation mt-5" novalidate>
      ...
      <div class="col-md-4 position-relative">
        ...
        <input type="text" class="form-control" id="validationTooltip04" required name="suffix">
        <div class="invalid-feedback">
      ...
      <div class="col-md-4 position-relative">
        ...
        <input type="text" class="form-control" id="validationTooltip05" required name="dob">
        <div class="invalid-feedback">
          Please provide a valid date of birth.
        </div>
      </div>
      <div class="col-md-4 position-relative">
        <label for="validationTooltip06" class="form-label">Gender</label>
        <input type="text" class="form-control" id="validationTooltip06" required name="gender">
        <div class="invalid-feedback">
      ...
      <div class="col-md-6 position-relative">
        ...
        <input type="text" class="form-control" id="validationTooltip07" required name="mobile">
        <div class="invalid-feedback">
      ...
      <div class="col-md-3 position-relative">
        ...
        <input type="text" class="form-control" id="validationTooltip16" required name="father_suffix">
        <div class="invalid-feedback">
      ...
      <div class="col-12">
        <button class="btn btn-primary" type="submit" name="s">Submit form</button>
      </div>
    </form>
  </section>
</body>
