...
<body>
    <section class="container my-4">
        <form method="POST" class="needs-validation border border-1 rounded p-4 p-md-5" novalidate>
            ...
            <div class="display-5 fw-bold mb-2 text-center">BIODATA</div>
            <hr>
            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-md-4 text-center">
                    <img
                        src="../profiles/<?= $row1["pfp"] ?>"
                        class="img-fluid rounded-circle object-fit-cover border border-dark border-4"
                        alt="profile"
                        style="width: 200px; height: 200px;">

                    <div class="row d-flex justify-content-center g-0 gap-2 mt-2">
                        <button class="col-8 btn btn-success" type="button" name="">Edit Profile</button>
                        <button class="col-8 btn btn-outline-danger" type="button">Delete Information</button>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-8">
                    ...
                    <div class="row g-2">
                        <div class="col-12 col-md-6">
                            <label for="father_fullName" class="form-label">Father's First Name</label>
                            <input type="text" class="form-control" id="father_firstName" name="father_fullName"
                                value="<?= strtoupper($row1["father_fullName"]) ?>" disabled>
                        </div>
                    </div>
                </div>
            </div>
